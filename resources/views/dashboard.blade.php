...
<div class="container">
  <div class="row justify-content-center mb-3">
      <div class="col-md-8">
          <div class="card">
              <div class="card-header">{{ __('Reaction Time Test') }}</div>
              <div class="card-body">
...
<script>
    $(document).ready(function () {
        ...
        function runTest() {
            var waitTime = Math.floor(Math.random() * 8) + 1; // Random interval waktu antara 1 hingga 8 detik
            $("#reaction-time-container").css("background-color", "red");
            $("#test-result").html("Mohon Tunggu...").show();
            setTimeout(function () {
                    ...
                    if (reactionTime <= 4000) {
                        ...
                        if (testCount === 20) {
                            ...
                            if (averageReactionTime < 1000 && testCount === 20) {
                                testResult = "Anda sangat cepat!";
                            } else if (averageReactionTime < 4000) {
                                testResult = "Anda cukup cepat.";
                            } else {
